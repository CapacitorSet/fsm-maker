...
stringa.STATI_RC = dati.io.input
...
stringa.SOGLIA_BASSA = Math.round(Math.pow(2, 16) * dati.antirimbalzo.schmitt.basso);
stringa.SOGLIA_ALTA = Math.round(Math.pow(2, 16) * dati.antirimbalzo.schmitt.alto);
